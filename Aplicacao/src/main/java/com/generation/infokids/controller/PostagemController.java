...
import com.generation.infokids.repository.PostagemRepository;
...
//	
	...
	public ResponseEntity<Postagem> put(@Valid @RequestBody Postagem postagem) {
		return repository.findById(postagem.getId()).map(resp -> ResponseEntity.ok().body(repository.save(postagem)))
